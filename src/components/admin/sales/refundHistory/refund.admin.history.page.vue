...
const fetchRefunds = async (resetPage = false) => {
  ...
  try {
    ...
    if (response.status === 'success') {
      recordsRefund.value = response.records;
        ...
        <div class="flex flex-col sm:flex-row gap-4">
          <div class="flex-1 relative">
            <input 
              type="text" 
              v-model="searchTerm"
              placeholder="Buscar por Google ID, nombre, email o valor..."
              class="w-full pl-10 pr-4 py-3 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            />
          ...
          <div class="sm:w-48">
            <select 
              ...
              class="w-full px-4 py-3 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            >
