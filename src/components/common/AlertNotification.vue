...
<template>
    <div v-if="show" 
         class="fixed top-5 right-5 z-[60] max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto border-l-4 overflow-hidden transform transition-all duration-300 ease-out"
         :class="alertClass">
