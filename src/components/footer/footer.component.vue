        ...
        <div class="footer-inner">
            ...
            <div class="footer-brand-col">
                ...
                <p class="footer-brand-desc">
                    Plataforma educativa premium con acceso vitalicio, contenido descargable de google drive y certificaciones reconocidas con posibilidad de reventa de cotenido.
                </p>
                <!-- Social icons -->
