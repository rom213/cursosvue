            ...
            <div class="border border-black rounded-sm p-0.5">
                ...
                <div class="px-1 grid">
                    ...
                    <div class="grid gap-2 pt-1">
                        <button @click="addCarCategory()" class="bg-[#2BA0FF] rounded-sm p-1">Agregar carrito</button>
                        <button @click="buyCategory()" class="bg-[#CDFF00] rounded-sm p-1">Comprar ${{ item.precio }}</button>
                    </div>
                </div>
