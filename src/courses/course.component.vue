...
<template>
        ...
        <div class="p-2 grid gap-3 text-sm">
            ...
            <div class="grid grid-cols-2 gap-2">
                <!-- section img -->
                <div class="border border-black rounded-sm p-0.5 relative">
                    ...
                    <div class="px-1 grid">
                        ...
                        <!-- seccion Agregar carrito y coprar -->
                        <div class="grid gap-2 pt-1">
                            ...
                            <!-- boton de precio -->
                            <button @click="()=>{storeemergentBuy.handleEmergentBuy(); storeemergentBuy.category=item}" class="bg-[#CDFF00] rounded-sm p-1">
                            ...
                            <br>
                            <p class="text-[10px] absolute bottom-0 w-full text-center"
                        ...
                        <div class="grid gap-2">
                            <div class="flex gap-3">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.25" y="0.25" width="23.5" height="23.5" stroke="black"
                                        stroke-width="0.5" />
