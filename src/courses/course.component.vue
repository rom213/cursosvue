...
<template>
  <div class="group bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col h-full">
    <!-- Header Section -->
    <div class="p-5 pb-0">
      <h3 
    ...
    <div class="p-5 pt-4 flex flex-col sm:flex-row gap-5 flex-grow">
      ...
      <div class="flex flex-col justify-between w-full sm:w-3/5 gap-4">
        <div @click="handleClickItem(item.id)" class="cursor-pointer space-y-4">
          <!-- Certificaction Badge -->
          <div class="flex items-center gap-2">
            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-blue-50 text-blue-700 ring-1 ring-inset ring-blue-700/10">
          ...
          <div class="space-y-3">
            ...
            <!-- Comments -->
            <div class="flex items-center gap-3 text-gray-700 group/item">
              <div class="p-1.5 rounded-lg bg-orange-50 text-orange-500 group-hover/item:bg-orange-100 transition-colors">
        ...
        <div class="mt-auto space-y-3">
          <div class="flex items-center gap-3">
            <!-- Preview Button -->
             <button title="Vista previa" class="p-2.5 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors">
                <div class="w-5 h-5" v-html="courseIcons.preview"></div>
             </button>
