...
<template>
    <div class="w-[150px]  border border-white rounded-lg p-1">
        <div>
            <img class="rounded-sm" src="../../assets/home/hero.jpg" alt="" srcset="">
        </div>
        <div class="flex text-whiten flex-col ">
            <h3 class="text-[#FFD21E] text-center">MARKENTING</h3>
