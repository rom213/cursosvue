...
export const proLessonContent: ProLessonMap = {
  ...
  m1: [
    // ── Lección 1 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "Ejercicio práctico para hoy: Abre Google Trends, compara 5 bloques de nuestro catálogo y anota los 2 que tengan tendencia ascendente. Luego ve a la Biblioteca de Anuncios de Meta, busca 3 competidores y captura de pantalla los 3 anuncios que más te llamen la atención. Con esto ya tienes los ingredientes para tu primera publicación de venta inteligente.",
      ],
      tipExperto:
        "No inventes la rueda: modela lo que ya le funciona a los grandes. Si Platzi está gastando dinero en un anuncio sobre IA, es porque ese bloque vende. Tú ofreces lo mismo por una fracción del precio. Usa su investigación a tu favor.",
    },
    ...
    // ── Lección 4 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "POSTS QUE FUNCIONAN SIN PARECER VENTA — Copia y adapta estos formatos: Formato \"Pregunta al grupo\": \"Pregunta seria para el grupo: ¿Cuántos de ustedes han intentado aprender [bloque] por YouTube y sienten que les falta estructura? Me pasó lo mismo y encontré algo que me funcionó. Si les interesa les cuento en los comentarios\". Formato \"Resultado personal\": \"No lo puedo creer. Acabo de [logro relacionado con lo que enseña el curso]. Hace 3 meses no sabía ni por dónde empezar. Lo que cambió todo fue dejar de aprender fragmentado y seguir un camino estructurado. ¿Alguien más ha sentido esa diferencia?\". Formato \"Recurso\": \"Hice un resumen de las 5 herramientas de [bloque] que más me han servido. Si quieren que se los comparta, comenten 'YO' y se los envío al privado\".",
      ...
      tipExperto:
        "Sé útil primero, vendedor después. La fórmula es simple: cada vez que alguien te escriba al privado porque vio tu comentario en un grupo, ya tienes el 50% de la venta hecha. La confianza se construyó antes de la conversación de ventas.",
    },
    ...
    // ── Lección 5 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "EL FORMATO QUE MÁS VENDE: EL UNBOXING DIGITAL. Graba la pantalla de tu celular o computadora mostrando las carpetas de Google Drive. Abre el Drive, navega por las carpetas organizadas por bloques (Programación, Marketing, Diseño, Excel...) y deja que la gente vea la cantidad masiva de contenido. Pon texto en pantalla que diga: \"Todo esto por menos de lo que cuesta un almuerzo\" o \"9.400 cursos. Un solo pago. De por vida\". Usa un audio en tendencia de fondo. Este formato funciona porque la gente quiere ver exactamente qué va a comprar, y cuando ven 23 carpetas llenas de cursos organizados, el valor es visualmente aplastante.",
        ...
        "FORMATO CARRUSEL DE FOTOS: TikTok ahora permite subir fotos como carrusel (Photo Mode) y este formato está teniendo un alcance descomunal. Crea 5-8 slides en Canva con tips rápidos sobre un bloque: \"5 atajos de Excel que nadie te enseñó\", \"3 herramientas de IA para ganar dinero desde casa\", \"Las 4 habilidades más pedidas en el mercado laboral 2026\". En la última slide pon: \"¿Quieres profundizar? Tengo acceso a más de 9.400 cursos. Link en mi perfil\" o \"Comenta CURSOS y te cuento cómo acceder\".",
  ...
  m2: [
    // ── Lección 1 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "PROMPT MAESTRO PARA POSTS DE FACEBOOK E INSTAGRAM — Copia y pega esto en ChatGPT o cualquier IA generativa: \"Actúa como un copywriter experto en ventas de cursos digitales para el mercado latinoamericano. Mi público son personas de 20-40 años que quieren mejorar sus ingresos o conseguir empleo. Necesito un post para Facebook/Instagram que venda un paquete de cursos que incluye [nombre del pilar o paquete, ej: Pilar de Tecnología con 8 bloques completos de programación, Excel, bases de datos, IA, etc.]. El precio es $18.700 COP (un solo pago, acceso de por vida en Google Drive). El dolor principal de mi cliente es [ej: quiere aprender a programar pero no tiene dinero para una academia cara]. El tono debe ser conversacional, como un amigo que recomienda algo. Usa español latinoamericano. Incluye emojis con moderación. Máximo 150 palabras. Termina con un llamado a acción que diga: Escribe INFO en los comentarios o envíame un DM\".",

        "PROMPT PARA ESTADOS DE WHATSAPP — Los estados de WhatsApp son una mina de oro subestimada. Tus contactos los ven todos los días. Usa este prompt: \"Genera 7 estados de WhatsApp para una semana completa promocionando un paquete de cursos de [bloque]. Cada estado debe tener máximo 2 líneas + 1 emoji. Distribuye así: Lunes = Motivación (identificar un dolor), Martes = Tip de valor gratuito, Miércoles = Testimonio o resultado, Jueves = Detrás de cámaras (qué incluye el paquete), Viernes = Oferta o urgencia, Sábado = Prueba social (número de estudiantes), Domingo = Recordatorio suave + llamado a la acción\". Con un solo prompt tienes contenido para toda la semana.",
    ...
    // ── Lección 2 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "A — ATENCIÓN (1 línea). Tienes exactamente 1 segundo para detener el scroll de tu prospecto. Necesitas un gancho que le haga decir \"espera, ¿qué?\". Aquí tienes hooks que funcionan para nuestros cursos: \"¿Sigues pagando miles por cursos que puedes tener por $18.700?\" / \"Lo que aprendí en 2 semanas vale más que mis 5 años de universidad\" / \"9.400 cursos. Un pago. Para siempre. No es broma\" / \"¿Estás cansado de ver tutoriales en YouTube que nunca terminan de enseñarte lo importante?\". Regla: si tu primera línea no genera curiosidad o emoción, borra todo y empieza de nuevo. Esta línea es el 80% de tu éxito.",
        ...
        "EJEMPLO COMPLETO APLICADO A LA TIENDA COMPLETA ($27.490): [A] \"¿Sabías que el 50% de lo que te enseñan en la universidad ya está desactualizado?\" [I] \"Yo también sentí esa frustración. Necesitaba habilidades reales para el mercado laboral de hoy, no teoría de hace 10 años. Probé tutoriales en YouTube pero era como armar un rompecabezas sin imagen de referencia\". [D] \"Hasta que encontré una plataforma con más de 9.400 cursos actualizados de tecnología, negocios y creatividad. Todo organizado, en Google Drive, con acceso de por vida y actualizaciones gratis. Un solo pago de $27.490 — menos de $3.000 al día si lo divides en un mes\". [A] \"Escríbeme CURSOS al DM y te muestro todo lo que incluye\".",
      ],
      tipExperto:
    ...
    // ── Lección 3 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "ESTRUCTURA 1: EL PROBLEMA — Duración: 15-30 segundos. Este formato ataca un dolor y presenta la solución. Guion para copiar: [Texto en pantalla segundo 0-3] \"Lo que las academias online NO quieren que sepas...\" [Texto segundo 3-8] \"Pagan cientos de miles por cursos que puedes conseguir por $18.700\" [Texto segundo 8-13] \"Un solo pago. Acceso de por vida. +9.400 cursos en Google Drive\" [Texto segundo 13-15] \"Link en mi perfil o comenta CURSOS\". Mientras el texto aparece en pantalla, muestra grabación de pantalla navegando por internet viendo precios de otras academias, o simplemente usa un fondo con movimiento. Pon un audio en tendencia de fondo a volumen bajo.",

        "ESTRUCTURA 2: EL UNBOXING DIGITAL — Duración: 15-30 segundos. Este es el formato más poderoso porque muestra el producto real. Guion: [Graba tu pantalla abriendo Google Drive] [Texto segundo 0-3] \"¿Esto es real? Mira todo lo que me llegó por $18.700\" [Empieza a abrir carpetas: Programación, Marketing, Diseño, Excel, IA...] [Texto segundo 8-12] \"23 bloques completos. Más de 9.400 cursos\" [Texto segundo 12-15] \"Un pago único. Tuyo para siempre. Link en mi perfil\". Truco: abre las carpetas rápido para que se vea la cantidad masiva de contenido. La velocidad genera impacto visual. Si alguna carpeta tiene subcarpetas, ábrela para que se vea la profundidad del material.",
  ...
  m3: [
    ...
    // ── Lección 2 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "LA GRABACIÓN PERFECTA — Paso a paso. Abre Google Drive en tu computadora (se ve mejor en pantalla grande que en celular). Usa una app de grabación de pantalla (OBS Studio es gratis para PC, o la función de grabación nativa en Mac). Ahora haz lo siguiente en este orden: (1) Muestra la carpeta raíz con los 23 bloques organizados por pilar. Que se vean todos los nombres: Programación, Excel, Marketing Digital, Diseño Gráfico, IA, etc. (2) Abre una carpeta — por ejemplo \"Programación\" — y muestra las subcarpetas: Python, JavaScript, HTML/CSS, React, etc. (3) Abre una subcarpeta y muestra los archivos reales: videos, PDFs, ejercicios. (4) Regresa a la carpeta raíz y abre otro pilar para que vean la variedad. Todo esto lo haces en 15-20 segundos, navegando con velocidad suficiente para que se vea la cantidad pero no tan rápido que no se distinga nada.",

        "TEXTO EN PANTALLA (obligatorio): En la parte superior del video pon el hook: \"¿Todo esto por $18.700? No puede ser real\" o \"Lo que recibí después de pagar $18.700\". En la parte inferior pon el cierre: \"Link en mi perfil. Acceso de por vida\". El texto debe ser grande, legible, con colores que contrasten con el fondo del Drive (blanco). Usa texto amarillo o blanco con sombra negra para máxima legibilidad.",

        "CÓMO GENERAR INTERACCIÓN (la clave del algoritmo). El algoritmo de TikTok prioriza videos que generan comentarios. Por eso, al final del video o en el texto en pantalla, haz una pregunta que invite a comentar: \"¿Qué bloque te gustaría aprender? Dímelo en los comentarios y te digo si lo tenemos\" o \"Comenta el nombre de un curso y te digo si está en el pack\". Cuando la gente comente, responde a TODOS. Cada respuesta tuya también cuenta como interacción para el algoritmo. Y a cada persona que comente algo relevante, puedes responder públicamente con valor y luego enviarle un DM: \"Vi que te interesa [bloque]. Si quieres te cuento cómo acceder al pack completo\".",
    ...
    // ── Lección 3 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "PASO 3 — LA TÉCNICA DE RESPUESTA PÚBLICA + PRIVADA. Cuando alguien comente \"Info\", \"Quiero\", \"¿Cómo accedo?\" o cualquier pregunta en tus publicaciones de Facebook, TikTok o Instagram, haz SIEMPRE estas dos cosas: (1) Responde públicamente con valor: \"¡Claro que sí! Es un pack con +9.400 cursos de [bloque que le interese], acceso de por vida en Google Drive. Te envío los detalles al privado\". (2) Inmediatamente después, envíale un mensaje privado/DM: \"Hola, vi tu comentario sobre los cursos. ¿Qué bloque te interesa más? Así te cuento cuál pack te conviene\". La respuesta pública es importante porque otros usuarios la ven y también se interesan. El mensaje privado es donde inicias la conversación de venta real.",
  ...
  m4: [
    ...
    // ── Lección 2 ──────────────────────────────────────────────────────────
    {
      ...
      tipExperto:
        "Usa la palabra \"inversión única\" en lugar de \"costo\" o \"precio\". Y siempre compara con lo que cuesta la alternativa: \"$200.000 al mes en Platzi vs $18.700 una sola vez aquí\". Cuando el prospecto hace esa comparación en su cabeza, el cierre es casi automático.",
    },
    ...
    // ── Lección 3 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "EL SCRIPT DEL GATILLO — Cuando el prospecto duda por el precio: \"Entiendo perfectamente, sé que todo está caro ahora. Mira, te voy a contar algo: tengo un cupón especial de descuento del 10% que no está disponible para todo el mundo. Con mi cupón, el Pilar Completo te queda en solo $43.650 en lugar de $18.700. Pero solo puedo mantener este precio hasta [mañana/este viernes]. Después de eso vuelve al precio normal. ¿Te reservo uno?\". La magia aquí es doble: primero, le estás dando un beneficio exclusivo que lo hace sentir especial; segundo, estás creando urgencia real con un límite de tiempo.",
  ...
  m6: [
    ...
    // ── Objeción 4 ─────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "SCRIPT PARA CUANDO SOSPECHAS QUE ES FALTA DE CONVENCIMIENTO (no de dinero): \"Te entiendo perfectamente, sé que la situación económica está difícil para todos. Justamente, muchos de nuestros estudiantes compraron los cursos precisamente para aprender habilidades que les permitan ganar más dinero. [Nombre del estudiante] aprendió marketing digital con este mismo pack y ahora maneja las redes de 3 negocios locales cobrando $500.000 al mes por cada uno. La pregunta no es si puedes pagarlo, sino cuánto te cuesta NO aprenderlo y seguir donde estás 6 meses más. Son solo $18.700, menos de $1.700 al día si lo divides en un mes. ¿Qué te parece si te reservo el precio con un descuento del 10% por 24 horas para que lo pienses con calma?\".",

        "SCRIPT PARA CUANDO GENUINAMENTE NO TIENEN EL DINERO AHORA: \"Te entiendo al 100%. Mira, no hay presión. Lo que sí te recomiendo es que me guardes en tus contactos porque periódicamente tenemos promociones especiales donde el precio baja aún más. También puedes empezar con un Bloque Individual por solo $9.900 — es un solo bloque específico que te interese, como Excel o programación, y ya empiezas a aprender hoy. Después, cuando puedas, te llevas el pilar completo con un 50% de descuento automático por ser alumno. ¿Te interesa empezar con un bloque individual mientras tanto?\".",

        "LA TÉCNICA DE LA RESERVA DE PRECIO: Si el prospecto dice que le interesa pero no puede pagar hoy, usa esta técnica de urgencia suave: \"Entiendo. Mira, lo que puedo hacer es guardarte mi cupón de descuento del 10% por las próximas 48 horas. Con el cupón, el Pilar Completo te queda en $43.650 en lugar de $18.700. Si el viernes ya puedes, me escribes y te envío el link con el descuento aplicado. ¿Te parece?\". Esto hace tres cosas: (1) Le da un plazo razonable para conseguir el dinero. (2) Le ofrece un incentivo extra para actuar dentro de ese plazo. (3) Establece un punto de seguimiento natural para que tú le escribas al vencer las 48 horas.",
