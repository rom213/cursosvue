  ...
  m5: [
    // ── Lección 1 ──────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "TUS NÚMEROS REALES — Veamos los márgenes con cada paquete usando el precio base que tú nos pagas vs lo que podrías cobrar: Bloque Individual: Tú pagas $7.840, vendes a $25.000-$35.000 → ganancia de $17.160-$27.160. Pilar Completo: Tú pagas $19.400, vendes a $70.000-$100.000 → ganancia de $50.600-$80.600. Combinación (2 Pilares): Tú pagas $30.280, vendes a $100.000-$150.000 → ganancia de $69.720-$119.720. Tienda Completa: Tú pagas $32.000, vendes a $120.000-$200.000 → ganancia de $88.000-$168.000. ¿Ves el poder? Con solo 1 venta de la Tienda Completa a $150.000, te llevas $118.000 LIMPIOS a tu bolsillo. Sin intermediarios, sin esperar aprobaciones, sin comisiones de plataforma.",
  ...
  m6: [
    ...
    // ── Objeción 4 ─────────────────────────────────────────────────────────
    {
      ...
      body: [
        ...
        "SCRIPT PARA CUANDO GENUINAMENTE NO TIENEN EL DINERO AHORA: \"Te entiendo al 100%. Mira, no hay presión. Lo que sí te recomiendo es que me guardes en tus contactos porque periódicamente tenemos promociones especiales donde el precio baja aún más. También puedes empezar con un Bloque Individual por solo $19.600 — es un solo bloque específico que te interese, como Excel o programación, y ya empiezas a aprender hoy. Después, cuando puedas, te llevas el pilar completo con un 70% de descuento automático por ser alumno. ¿Te interesa empezar con un bloque individual mientras tanto?\".",
